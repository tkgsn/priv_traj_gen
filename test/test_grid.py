...
class QuadTreeTestCase(unittest.TestCase):
    ...
    def test_make_hidden_ids(self):
        self.assertEqual(self.tree.node_id_to_hidden_id[:10], [100000000, 0, 1, 2, 3, 4, 5, 8, 9, 6])
    
    def test_node_id_to_hidden_id(self):
        node_id_to_hidden_id = self.tree.node_id_to_hidden_id
        answer = [100000000, 0, 1, 2, 3, 4, 5, 8, 9, 6, 7, 10, 11, 12, 13, 16, 17, 14, 15, 18, 19, 20, 21, 28, 29, 22, 23, 30, 31, 36, 37, 44, 45, 38, 39, 46, 47, 24, 25, 32, 33, 26, 27, 34, 35, 40, 41, 48, 49, 42, 43, 50, 51, 52, 53, 60, 61, 54, 55, 62, 63, 68, 69, 76, 77, 70, 71, 78, 79, 56, 57, 64, 65, 58, 59, 66, 67, 72, 73, 80, 81, 74, 75, 82, 83]
