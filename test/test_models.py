...
import sys
sys.path.append('./')
from models import GRUNet, MetaGRUNet, compute_loss_meta_gru_net, GRUQuadTreeNetwork, compute_loss_gru_meta_gru_net, LinearQuadTreeNetwork, FullLinearQuadTreeNetwork, MetaNetwork, Markov1Generator
from my_utils import construct_default_quadtree, privtree_clustering
import numpy as np
import torch
...
class TConvQuadTreeNetworkTestCase(unittest.TestCase):
  def __init__(self, *args, **kwargs):
    super(TConvQuadTreeNetworkTestCase, self).__init__(*args, **kwargs)
    n_bins = 6
